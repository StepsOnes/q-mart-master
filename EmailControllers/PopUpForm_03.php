...
// PopUp Form_01
$name = $_POST["popup_name-03"];
$phone = $_POST["popup_phone-03"];
$email = $_POST["popup_email-03"];
...
<div class='container'>
    <h1>Запрос бизнес модели от пользователя</h1>
...
$mail->Subject = 'Запрос бизнес модели от пользователя';
$mail->Body = $str;
$mail->AltBody = '';
